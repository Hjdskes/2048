...
/**
 * A button to launch a singleplayer game.
 */
public class SinglePlayerButton extends MenuButton implements Drawable {
	/**
	 * Creates a new SinglePlayerButton with the specified parameters.
	 * 
	 * @param x
	...
	/**
	 * Handles the click event. Launches a singleplayer game.
	 */
	@Override
	...
	public void draw(Batch batch) {
		batch.draw(AssetHandler.single, super.getX(), super.getY(), super.getWidth(), super.getHeight());
	}
}
